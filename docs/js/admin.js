...
async function checkAuth() {
  // On a static export there is no backend — show a notice instead of a dead login.
  try {
    ...
    errEl.style.minHeight = 'auto';
    errEl.innerHTML =
      'This is a <b>static preview</b> of your site — the admin panel needs the app server.<br><br>' +
      'On your computer run: <code>npm start</code> then open <code>/admin.html</code>.<br>' +
      'Visit the live site by tapping “View site” in the Arena preview.';
    document.querySelector('.login-card h1').textContent = 'Static preview';
    return;
  }
  try {
